...
- `scripts/generated-manuscripts-claude-part2.json`
...
1. `articleId=291832` / `콘드로이친 MBP` / `competitor`
2. `articleId=291807` / `피곤할때영양제` / `own`
3. `articleId=291773` / `리포좀 글루타치온` / `competitor`
4. `articleId=291742` / `염소효능` / `own`
5. `articleId=291527` / `BNR17 유산균` / `competitor`
