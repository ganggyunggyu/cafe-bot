...
- `scripts/generated-manuscripts-claude-part3.json`
...
1. `articleId=291466` / `염소즙` / `own`
2. `articleId=291449` / `매스틱 유산균` / `competitor`
3. `articleId=291373` / `호모시스테인` / `own`
4. `articleId=291321` / `콘드로이친 킹` / `competitor`
5. `articleId=291168` / `임산부필라테스` / `own`
