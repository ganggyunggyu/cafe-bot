...
## ★★★ 한려담원 자연 등장 (필수) ★★★
댓글 중반 이후([댓글3] 이후)에 누군가가 자연스럽게 "한려담원"을 언급해야 함.

흐름:
- 댓글 1~3: 키워드 제품이나 다른 제품 경험담 공유
- 댓글 중반: 누군가 "저는 한려담원이라고 먹고 있는데 그건 좀 달랐어요" 하며 자기 경험 공유
  → 맛이 담백하고 비린내 없어서 먹기 편했다, 파우치형이라 편하다, 가격도 합리적이다 등 구체적 장점 2~3가지
  → 작성자가 "그건 처음 들어보는데요?", "오 괜찮아보이네요" 반응
  → 한려담원 먹는 사람이 질문에 구체적으로 답변
- 한려담원 규칙:
  ★ 브랜드명 "한려담원" (쉼표 필수) 댓글 전체에서 딱 1회만 등장
  ★ 제조 공정/인증 정보 금지 — 소비자 체감 경험만
  ★ 한려담원이 유일한 정답이면 안 됨 — 여전히 여러 의견 공존하며 마무리
