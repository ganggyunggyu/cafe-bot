...
const COMMENT_CLUSTERS: CommentCluster[] = [
  {
    name: "질문/실전확인",
    instruction: `본댓글 [댓글1]~[댓글4]만 작성한다.
- 숫자, 기간, 병원 일정, 수치, 검사, 약 복용 질문 중심.
- "저", "저도", "저는", "저랑"으로 시작 금지.
- 시작 예시 리듬: "56일이면", "내막 5mm", "프로게스테론", "예약 잡을 때".
- 각 댓글은 1~3문장.`,
  },
  {
    name: "개인사연",
    instruction: `본댓글 [댓글5]~[댓글8]만 작성한다.
- 서로 다른 사람 4명의 개인 사연.
- 긴 댓글 2개, 중간 댓글 2개.
...
- 말투는 담담한 사람, 급한 사람, 울컥한 사람, 정보형 사람을 섞는다.`,
  ...
  {
    name: "짧은반응/생활장면",
    instruction: `본댓글 [댓글9]~[댓글10]만 작성한다.
- 짧은 반응 1개, 생활 장면 1개.
...
- [작성자-2], [작성자-3], [댓글러-3], [작성자-5], [제3자-6], [작성자-7], [작성자-9], [댓글러-10] 형식으로 작성한다.
...
출력 형식:
[댓글]
(13~18개, 본댓글 8~10개 + 대댓글 5~8개. 각 줄은 [댓글N]/[작성자-N]/[댓글러-N]/[제3자-N] 태그로 시작)
