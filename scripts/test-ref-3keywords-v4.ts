...
const KEYWORDS: KeywordEntry[] = [
  { category: '임신준비', keyword: '40대 중반 임신 확률' },
  { category: '산후조리', keyword: '출산 후 몸조리' },
  { category: '임신준비', keyword: '40대 출산' },
  { category: '산후조리', keyword: '산후 호박즙' },
  { category: '임신준비', keyword: '착상 음식' },
];
...
const main = async () => {
  console.log(`\n채널언급+배합강화 원고 생성 (${KEYWORDS.length}개)`);
