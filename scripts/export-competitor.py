...
GID = 914355730
batch_dir = "manuscripts/competitor-results"
...
KEYWORDS = [
    '흑염소진액', '흑염소진액 추천', '이경제 흑염소진액',
    '본정심 흑염소진액', '흑염소진액 브랜드', '흑염소진액 선물',
    '흑염소 보양식', '흑염소진액 비교', '흑염소진액 효과',
    '흑염소진액 부모님'
]
