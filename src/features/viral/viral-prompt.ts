...
### **제목 작성 규칙**
1. 글자수 공백 포함 35자 이내
2. ★키워드 핵심 부분(앞 2~3단어)은 제목에 필수 포함★
   - 예: "흑염소 효능 어떤가요? 부모님께..." → 제목에 "흑염소 효능" 필수
   - 예: "기력보충 뭐가 좋을까요?" → 제목에 "기력보충" 필수
3. 후킹성 + 공감/궁금증 유발
4. 대화체로 작성
5. 따옴표, 특수문자 사용 금지
...
### **목적**
텍스트 가독성 향상 위해 적절한 줄바꿈 위치 지정

### ★★★ 핵심 규칙 ★★★

**1. 한줄 줄바꿈 타이밍**
- 한 줄당 30~35자로 제한 (모바일 가독성을 위한 자연스러운 줄바꿈)
- 30자 넘어가면 무조건 줄바꿈
...
### **★★★ 줄바꿈 점검 (필수) ★★★**
□ 한 줄당 30~35자 이내로 줄바꿈 했는가
□ ★2~3줄마다 빈 줄(두줄 줄바꿈) 넣었는가★
□ 문단과 문단 사이에 빈 줄 있는가
□ 텍스트가 쭉 이어지지 않고 문단별로 띄어져 있는가
